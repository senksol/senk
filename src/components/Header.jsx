      ...
      <header className={`heading ${scrolled ? 'position-fixed' : ''}`}>
        <Container className='d-flex align-items-center justify-content-between'>
          ...
          <div className="heading-actions d-flex align-items-center flex-wrap">
            <a href="https://t.me/senk_community" target='_blank' className='btn d-inline-flex align-items-center gap-2 justify-content-center'>
              <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.417 13.1809L9.02 18.7649C9.588 18.7649 9.83399 18.5209 10.129 18.2279L12.792 15.6829L18.31 19.7239C19.322 20.2879 20.035 19.9909 20.308 18.7929L23.93 1.82092L23.931 1.81992C24.252 0.323917 23.39 -0.261083 22.404 0.105917L1.11399 8.25692C-0.339005 8.82092 -0.317005 9.63092 0.866995 9.99792L6.30999 11.6909L18.953 3.77992C19.548 3.38592 20.089 3.60392 19.644 3.99792L9.417 13.1809Z" fill="black" />
              </svg>
              Telegram
            </a>
